...
gulp.task("webpack", function(callback) {
  ...
  // console.log('myConfig', myConfig, webpackConfig)
...
gulp.task('build.css', function () {
   ...
   * @type {[*]}
   */
  var themes = ['theme1', 'theme11', 'theme12', 'theme13', 'theme14', 'theme15', 'theme16', 'theme17', 'theme18', 'theme19', 'theme20'];
  // var themes = ['theme1'];
...
gulp.task('copy',function(){
   ...
   * @type {[*]}
   */
  var themes = ['common', 'theme1',  'theme11',  'theme12',  'theme13',  'theme14',  'theme15',  'theme16', 'theme17', 'theme18', 'theme19', 'theme20'];
